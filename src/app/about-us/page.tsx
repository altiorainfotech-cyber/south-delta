  ...
  return (
    <>
      ...
      <section className="relative w-full h-[90vh] md:min-h-screen overflow-hidden">
        ...
        {/* Content */}
        <div
          className={`relative z-10 flex flex-col justify-center h-[90vh] md:min-h-screen px-6 md:px-16 lg:px-24 py-8 transition-all duration-[1500ms] ease-out delay-500 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          <div className="max-w-2xl">
            {/* Main Title */}
            <h1 className="font-rowdies text-[36px] sm:text-[44px] md:text-[52px] lg:text-[60px] font-normal leading-none tracking-tight text-white mt-[45px]">
              GET TO KNOW US
            </h1>

            {/* Tagline */}
            <div className="mt-4">
              <p className="font-inter text-[14px] sm:text-[16px] md:text-[18px] text-white/90 tracking-[0.15em] md:tracking-[0.31em]">
                We Are Certified Company
              </p>
              <p className="font-italianno text-[48px] sm:text-[60px] md:text-[72px] lg:text-[88px] text-white leading-none mt-2 md:-mt-2 ml-0 sm:ml-[100px] md:ml-[180px] lg:ml-[280px]">
                Since 1997
              </p>
            </div>
            ...
            <div className="mt-6 md:mt-8 flex gap-4">
              <Link
                href="#"
                aria-label="TikTok"
                className={`flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-lg bg-[#FDC052] transition-all duration-[1000ms] ease-out delay-[1200ms] hover:scale-110 ${
              ...
              <Link
                ...
                className={`flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-lg bg-[#FDC052] transition-all duration-[1000ms] ease-out delay-[1400ms] hover:scale-110 ${
                  isLoaded ? "opacity-100 scale-100" : "opacity-0 scale-0"
                }`}
              >
                <svg
      ...
      <section
        className="relative bg-no-repeat bg-cover -mt-[220px] pt-[200px]"
        style={{
      ...
      >
        ...
        <div className="w-full lg:w-[55%]">
          {/* Welcome Section */}
          <div ref={welcomeRef} className="py-16 px-8 md:px-16 lg:px-24  md:mt-5 pt-20">
