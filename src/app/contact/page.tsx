...
export default function Contact() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative w-full min-h-[500px] overflow-hidden pt-[100px]">
        {/* Background Image */}
        ...
        {/* Content */}
        <div
          className={`relative z-10 flex flex-col lg:flex-row justify-between items-start h-full px-8 md:px-16 lg:px-24 py-32 transition-all duration-[1500ms] ease-out ${
        ...
        >
          ...
          <div className="max-w-xl">
            {/* Main Title */}
            <h1 className="font-rowdies text-[60px] font-normal leading-none tracking-tight text-white mb-8">
              LET'S CONNECT
            </h1>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  ...
                  className="font-inter text-[18px] text-white hover:text-[#FDC052] transition-colors"
                >
                  +17-788343592
                </Link>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  ...
                  className="font-inter text-[18px] text-white underline hover:text-[#FDC052] transition-colors"
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-inter text-[18px] text-white">Canada</span>
              </div>
            </div>
